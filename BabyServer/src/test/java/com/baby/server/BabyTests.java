...
public class BabyTests {
    ...
    public void equationsIsEqualFortyTwoExpectsTrue() {
    ...
    public void checkIfIsEqualToFortyTwo() {
    ...
    public void expectReturnTrueIfTipsIsCCCCCC() {
    ...
    public void expectReturnTrueIfTipsIsCCCXXX() {
    ...
    public void expectReturnTrueIfTipsIsTTTTCC() {
